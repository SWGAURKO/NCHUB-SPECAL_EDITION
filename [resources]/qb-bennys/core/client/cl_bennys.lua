...
local bennyLocation = vector3(-212.074, -1325.449, 30.220397)
local bennyPDLocation = vector3(449.496, -975.8898, 25.699989)
local bennyVPDLocation = vector3(544.52886, 10.523838, 68.902755)
local bennyspaletopd = vector3(1817.6716, 3680.7351, 33.297969)
local SANDYbennys = vector3(1881.3057, 3700.363, 33.359371)
...
AddEventHandler('event:control:pdbennys', function(useID)
...
RegisterNetEvent('event:control:vpdbennys')
AddEventHandler('event:control:vpdbennys', function(useID)
    if job == "police" and IsPedInAnyPoliceVehicle(PlayerPedId()) and IsPedInAnyVehicle(PlayerPedId(), false) then
        useID = 1
        bennyHeading = 301.4653
        if useID == 1 then -- VPD Bennys
            enterLocation(bennyVPDLocation)
        end
    end
end)

RegisterNetEvent('event:control:SANDYbennys')
AddEventHandler('event:control:SANDYbennys', function(useID)
    if job == "police" and IsPedInAnyPoliceVehicle(PlayerPedId()) and IsPedInAnyVehicle(PlayerPedId(), false) then
        useID = 1
        bennyHeading = 31.81878
        if useID == 1 then -- PD Bennys
            enterLocation(SANDYbennys)
        end
    end
end)
