...
CONFIG.Option = {                                           -- Option
    ...
    Display = {                                             -- Display
        ...
        Activity = {                                        -- กิจกรรม
            Enable = false,                                  -- แสดง สถานะกิจกรรมผู้เล่น (true เท่ากับ เปิดใช้งาน | false เท่ากับ ปิดใช้งาน)
...
CONFIG.Discord = {                                          -- Discord
    Application = {                                         -- Application (Developer Portal: https://discord.com/developers/applications)
        ID = 1241590061108035724                            -- ID (รูปภาพตัวอย่าง: https://i.imgur.com/cWZjHB3.png)
    },
    ...
    Asset = {                                               -- Asset (Art Assets: https://discord.com/developers/applications/YOUR_APP_ID/rich-presence/assets)
        Logo = {                                            -- ภาพสัญลักษณ์ (ขนาดปกติ)
            Name = 'logo',                            -- ชื่อ (รูปภาพตัวอย่าง: https://imgur.com/y1Amkyu.png)
            Text = 'NCHub'                    -- ข้อความ
        },

        Icon = {                                            -- ภาพสัญลักษณ์ (ขนาดเล็ก)
            Name = 'logo',                            -- ชื่อ (รูปภาพตัวอย่าง: https://i.imgur.com/0STQ7rh.png)
            Text = 'NCHub'                    -- ข้อความ
        }
    },
