...
RegisterNetEvent('qb-metaldetector:CommonTradingMenu', function(data)
    exports['qb-menu']:openMenu({
        ...
        },
        {
            id = 2,
            header = "Metal Trash",
            txt = "Trade 45 Metal Trash for $1,500!",
            params = {
                isServer = true,
        ...
        },
        {
            id = 3,
            header = "Iron Trash",
            txt = "Trade 45 Iron Trash for $3,000!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:CommonTrade",
                args = {
        ...
        },
        {
            ...
            txt = "Trade 45 Bullet Casings for $4,000!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:CommonTrade",
                args = {
        ...
        },
        {
            ...
            txt = "Trade 45 Aluminum Cans for $5,000!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:CommonTrade",
                args = {
        ...
        },
        {
            id = 6,
            header = "Steel Trash",
            txt = "Trade 45 Steel Trash for $6,000!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:CommonTrade",
                args = {
        ...
        },
        {
            ...
            txt = "Trade 45 Broken Knives for $7,000!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:CommonTrade",
                args = {
        ...
        },
        {
            ...
            txt = "Trade 45 Broken Metal Detectors for $8,000!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:CommonTrade",
                args = {
        ...
        },
        {
            id = 9,
            header = "House Keys",
            txt = "Trade 45 House Keys for $9,000!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:CommonTrade",
                args = {
        ...
        txt = "Trade 45 Broken Phones for $10,000!",
        params = {
            isServer = true,
            event = "qb-metaldetector:server:CommonTrade",
            args = {
