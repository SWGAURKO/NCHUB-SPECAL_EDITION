...
Config.CommonPedLocation = vector4(-1337.558, -1251.982, 5.9432988, 116.84697)
Config.CommonPed = 'mp_m_weapexp_01'

-- rare trade ped location & ped hash
Config.RarePedLocation = vector4(-555555.17, -1017.98, 12.78, 74.19)
Config.RarePed = 'mp_m_weapexp_01'

-- the amount of time it takes to detect items. (progressbar)
Config.DetectTime = math.random(6000, 14000) 

-- if doesnt land on common or rare you get nothing.
-- 70% chance of receiving common item.
Config.CommonChance = 70

-- 2% chance of receiving rare item.
Config.RareChance = 98
...
-- %45 chance of overheating. 
Config.OverheatChance = 33 
