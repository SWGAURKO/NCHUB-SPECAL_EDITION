...
RegisterServerEvent('qb-metaldetector:server:CommonTrade', function(data)
    ...
    if data.id == 2 then
        if check ~= nil then
            if check.amount >= 45 then
                Player.Functions.RemoveItem(item, 45)
                Player.Functions.AddMoney('cash', 500)
                TriggerClientEvent('QBCore:Notify', src, 'You traded 45 Metal Trash'..' for $500.', 'success')
            else 
    ...
    elseif data.id == 3 then 
        if check ~= nil then
            if check.amount >= 45 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 45 Iron Trash'..' for $1,000.', 'success')
            else 
    ...
    elseif data.id == 4 then 
        if check ~= nil then
            if check.amount >= 45 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 45 Bullet Casings'..' for $1,500.', 'success')
            else 
    ...
    elseif data.id == 5 then 
        if check ~= nil then
            if check.amount >= 45 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 45 Aluminum Cans'..' for $2,000.', 'success')
            else 
    ...
    elseif data.id == 6 then 
        if check ~= nil then
            if check.amount >= 45 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 45 Aluminum Cans'..' for $2,500.', 'success')
            else 
    ...
    elseif data.id == 7 then 
        if check ~= nil then
            if check.amount >= 45 then
                Player.Functions.RemoveItem(item, 45)
                Player.Functions.AddMoney('cash', 3000)
                TriggerClientEvent('QBCore:Notify', src, 'You traded 45 Aluminum Cans'..' for $3,000.', 'success')
            else 
    ...
    elseif data.id == 8 then 
        if check ~= nil then
            if check.amount >= 45 then
                Player.Functions.RemoveItem(item, 45)
                Player.Functions.AddMoney('cash', 3500)
                TriggerClientEvent('QBCore:Notify', src, 'You traded 45 Aluminum Cans'..' for $3,500.', 'success')
            else 
    ...
    elseif data.id == 9 then 
        if check ~= nil then
            if check.amount >= 45 then
                Player.Functions.RemoveItem(item, 45)
                Player.Functions.AddMoney('cash', 4000)
                TriggerClientEvent('QBCore:Notify', src, 'You traded 45 Aluminum Cans'..' for $4,000.', 'success')
            else 
    ...
    elseif data.id == 10 then 
        if check ~= nil then
            if check.amount >= 45 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 45 Aluminum Cans'..' for $4,500.', 'success')
            else 
