...
Config = {
	...
	JimShops = false, -- Set this to true if using qb-shops
	...
	Timings = { -- Time it takes to do things
		["Cracking"] = math.random(4000, 5500),
		["Washing"] = math.random(1000, 3000),
		["Panning"] = math.random(3000, 7500),
		["Pickaxe"] = math.random(15000, 18000),
		["Mining"] = math.random(10000, 15000),
		["Laser"] = math.random(7000, 7000),
		["OreRespawn"] = math.random(35000, 55000),
		["Crafting"] = 5000,
	},
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "bandage", price = 50, amount = 100, info = {}, type = "item", slot = 1, },
			{ name = "weapon_flashlight", price = 0, amount = 100, info = {}, type = "item", slot = 2, },
			{ name = "goldpan", price = 75, amount = 100, info = {}, type = "item", slot = 3, },
			{ name = "pickaxe",	price = 100, amount = 100, info = {}, type = "item", slot = 4, },
			{ name = "miningdrill",	price = 6000, amount = 50, info = {}, type = "item", slot = 5, },
			{ name = "mininglaser",	price = 10000, amount = 5, info = {}, type = "item", slot = 6, },
			{ name = "drillbit", price = 5, amount = 100, info = {}, type = "item", slot = 7, },
		},
	},
}
Crafting = {
