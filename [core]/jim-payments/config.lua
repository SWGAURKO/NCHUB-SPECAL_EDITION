...
Config = {
	...
	PhoneBank = false, 	-- Set this to false to use the popup payment system FOR CARD/BANK PAYMENTS instead of using phone invoices
						...
						PhoneBankPolice = true,

	PhoneType = "qb", -- Change this setting to make invoices work with your phone script [still testing this currently]
						-- "qb" for qb-phone
						-- "gks"" for GKSPhone

	CashInLocation = vector4(243.4029, 225.12152, 0.41831, 339.02758), -- Default Third Window along in Pacific Bank
	...
	Jobs = {
		...
		['pawn'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['burgershot'] = { MinAmountforTicket = 50, PayPerTicket = 50 , Commission = 0.10, },
		['casino'] = { MinAmountforTicket = 50, PayPerTicket = 50 , Commission = 0.10, },
		['whitewidow'] = { MinAmountforTicket = 50, PayPerTicket = 50 , Commission = 0.10, },
		['police'] = { MinAmountforTicket = 50, PayPerTicket = 50 , Commission = 0.0, },
		...
		['taco'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['pizzathis'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['coolbeans'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		...
		['beanmachine'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.10, },
