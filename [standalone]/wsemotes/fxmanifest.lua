--- wsemotes by TayMcKenzieNZ, Mathu_Imn and MadsL, maintained by TayMcKenzieNZ ---
--- Download OFFICIAL version and updates ONLY at https://github.com/TayMcKenzieNZ/wsemotes ---
--- wsemotes is FREE and ALWAYS will be. STOP PAYING SCAMMY FUCKERS FOR SOMEONE ELSE'S WORK!!! ---

fx_version 'cerulean'
game 'gta5'
authors { '#', 'MadsL', '#', 'Community' }
description 'wsemotes V1.2.6'
lua54 'yes'
...
data_file 'DLC_ITYP_REQUEST' 'stream/taymckenzienz_wsemotes.ytyp'
