...
RP.Emotes = {
    ...
    ["holster2"] = { --- Custom Emote Provided To wsemotes By Mads
...
RP.PropEmotes = {
    ...
    ["macaroon"] = { --- Custom Prop by Bzzzi
        ...
        ["onionring"] = { --- Custom Prop by ORIDN A KING 
        "mp_player_inteat@burger",
        "mp_player_int_eat_burger",
        "Macaroon",
        AnimationOptions = {
            Prop = 'oridn_onionring',
            PropBone = 18905,
            PropPlacement = {
                0.15,
                0.07,
    ...
    ["burgerpose"] = { -- Custom Emote By Dark Animations exclusive to wsemotes exclusive to wsemotes
   ...
   ["colakrub"] = {
    ...
    ["microck"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p1",
        "mic@p1",
        "Microphone Rock",
        AnimationOptions = {
    ...
    ["microckb"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p2",
        "mic@p2",
        "Microphone Rock 2",
        AnimationOptions = {
    ...
    ["microckc"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p3",
        "mic@p3",
        "Microphone Rock 3",
        AnimationOptions = {
    ...
    ["microckd"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p4",
        "mic@p4",
        "Microphone Rock 4",
        AnimationOptions = {
    ...
    ["microcke"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p5",
        "mic@p5",
        "Microphone Rock 5",
        AnimationOptions = {
    ...
    ["microckf"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p6",
        "mic@p6",
        "Microphone Rock 6",
        AnimationOptions = {
    ...
    ["microckg"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p7",
        "mic@p7",
        "Microphone Rock 7",
        AnimationOptions = {
    ...
    ["microckh"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p8",
        "mic@p8",
        "Microphone Rock 8",
        AnimationOptions = {
    ...
    ["microcki"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p9",
        "mic@p9",
        "Microphone Rock 9",
        AnimationOptions = {
    ...
    ["microckj"] = { --- Custom Emote Provided To wsemotes By Prue颜
        "lunyx@mic@p10",
        "mic@p10",
        "Microphone Rock 10",
        AnimationOptions = {
    ...
    ["airportbag2"] = { -- Custom Emote By Dark Animations exclusive to wsemotes 
        "suitcase_phone@dark",
        "suitcase_phone_clip",
        "Airport Bag 2 - Phone",
        AnimationOptions = {
    ...
    ["gamer2"] = { --- Custom Emote By Dark Animations exclusive to wsemotes
        "lay_controller@dark",
        "lay_controller_clip",
    ...
    ["study"] = { --- Custom Emote By Dark Animations exclusive to wsemotes
    ...
    ["sax"] = {
        ...
        "Saxophone 1",
        AnimationOptions = {
            Prop = 'wsemotes_prop_saxophone01',
            PropBone = 57005,
            PropPlacement = {
               0.0700,
               0.0400,
    ...
    ["sax2"] = {
       ...
       "play_saxophone_clip",
        "Saxophone 2",
        AnimationOptions = {
            Prop = 'wsemotes_prop_saxophone02',
            PropBone = 57005,
            PropPlacement = {
               0.0700,
               0.0400,
