...
local function debugPrint(text)
    ...
    if WarMenuS.debug then

        Citizen.Trace('[WarMenuS] '..tostring(text))
...
function WarMenuS.CreateMenu(id, title)
...
function WarMenuS.SetMenuTitle(id, title)
...
function WarMenuS.SetMenuSubTitle(id, title)
...
function WarMenuS.CreateSubMenu(id, parent, subTitle)

    if menus[parent] then

        WarMenuS.CreateMenu(id, menus[parent].title)
...
function WarMenuS.IsMenuOpened(id)
...
function WarMenuS.IsMenuAboutToBeClosed()
...
function WarMenuS.Button(text, subText, color)
...
function WarMenuS.GetCurrentButton()
...
function WarMenuS.MenuButton(text, id, color)

    if menus[id] then

        if WarMenuS.Button(text, nil, color) then
...
function WarMenuS.CheckBox(text, bool, callback)
    ...
    if WarMenuS.Button(text, checked) then
...
function WarMenuS.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if WarMenuS.Button(text, selectedItem) then
...
function WarMenuS.SetMenuWidth(id, width)
...
function WarMenuS.SetMenuX(id, x)
...
function WarMenuS.SetMenuY(id, y)
...
function WarMenuS.SetMenuMaxOptionCountOnScreen(id, count)
...
function WarMenuS.SetTitleColor(id, r, g, b, a)
...
function WarMenuS.SetTitleBackgroundColor(id, r, g, b, a)
...
function WarMenuS.SetSubTitle(id, text)
...
function WarMenuS.SetMenuBackgroundColor(id, r, g, b, a)
...
function WarMenuS.SetMenuTextColor(id, r, g, b, a)
...
function WarMenuS.SetMenuSubTextColor(id, r, g, b, a)
...
function WarMenuS.SetMenuFocusColor(id, r, g, b, a)
...
function WarMenuS.SetMenuButtonPressedSound(id, name, set)
