...
globalConfig = {
  ...
  props = { 
    ...
    {x = -82.44, y = -1327.28, z = 29.28, model = 'prop_arm_wrestle_01'},
    {x = -82.44, y = -1327.28, z = 29.28, model = 'bkr_prop_clubhouse_arm_wrestle_01a'},
    {x = -82.44, y = -1327.28, z = 29.28, model = 'bkr_prop_clubhouse_arm_wrestle_02a'},
