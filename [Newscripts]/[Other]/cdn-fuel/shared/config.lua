...
Config.SyphonDispatchSystem = "qb-dispatch" -- Options: "qb-dispatch", "qb-dispatch", "qb-default" (just blips) or "custom" (Custom: you must configure yourself!)
...
Config.JerryCanPrice = 1750 -- The price of a jerry can, not including tax.
...
Config.StationFuelSalePercentage = 0.90 -- % of sales that the station gets. If they sell 4 Liters of Gas for $16 (not including taxes), they will get 16*Config.StationFuelSalePercentage back from the sale. Treat this as tax, also, it balances the profit margins a bit.
...
Config.MaxFuelReserves = 50000 -- This is the maximum amount that the fuel station's reserves can hold.
Config.FuelReservesPrice = 2.0 -- This is the price of fuel reserves for gas station owners.
Config.GasStationSellPercentage = 60 -- This is the percentage that players will get of the gas stations price, when they sell a location!
Config.MinimumFuelPrice = 2 -- This is the minimum value you want to let players set their fuel prices to.
Config.MaxFuelPrice = 16 -- This is the maximum value you want to let players set their fuel prices to.
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    --     zones = {
    --         vector2(161.3523, -905.603),
    --         vector2(244.5346, -935.091),
    --         vector2(263.910, -877.382),
    --         vector2(188.4763, -850.039)
    --     },
    --     minz = 28.59645,
    --     maxz = 30.59645,
    --     pedmodel = "a_m_m_indian_01",
    ...
    --     },
    --     electriccharger = nil,
    --     electricchargercoords = vector4(174.41598, -892.5524, 29.72779, 248.63951),
    --     label = "Legion Park Gas Station",
    -- },
    --[[
