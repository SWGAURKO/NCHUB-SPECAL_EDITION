...
Config.TextUI_Open = function(msg)
	...
	-- Here you can use your TextUI or use my free one - https://github.com/vames-dev/interact
end
...
Config.Tattooshops = {
    {
		...
		ownerJob = "tatto", -- If business is on true, here you must specify the work that has in this salon to manage
