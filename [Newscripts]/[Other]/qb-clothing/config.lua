...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1694.0487, 4821.8911, 42.063064), width = 2, length = 2},
    [2] = {shopType = 'clothing', coords = vector3(-710.4036, -152.1305, 37.415161), width = 2, length = 2},
    [3] = {shopType = 'clothing', coords = vector3(-1193.129, -768.0048, 17.31859), width = 2, length = 2},
    [4] = {shopType = 'clothing', coords = vector3(425.55383, -807.1151, 29.491113), width = 2, length = 2},
    [5] = {shopType = 'clothing', coords = vector3(-163.7851, -303.8533, 39.733264), width = 2, length = 2},
    [6] = {shopType = 'clothing', coords = vector3(75.470573, -1392.029, 29.376117), width = 2, length = 2},
    [7] = {shopType = 'clothing', coords = vector3(-821.7565, -1073.22, 11.328096), width = 2, length = 2},
    [8] = {shopType = 'clothing', coords = vector3(-1449.62, -236.675, 49.810634), width = 2, length = 2},
    [9] = {shopType = 'clothing', coords = vector3(4.3335175, 6511.9204, 31.877847), width = 2, length = 2},
    [10] = {shopType = 'clothing', coords = vector3(614.24389, 2762.8813, 42.088073), width = 2, length = 2},
    [11] = {shopType = 'clothing', coords = vector3(1197.4869, 2710.2202, 38.222579), width = 2, length = 2},
    [12] = {shopType = 'clothing', coords = vector3(-3170.536, 1043.6773, 20.863204), width = 2, length = 2},
    [13] = {shopType = 'clothing', coords = vector3(-1100.807, 2711.0874, 19.107841), width = 2, length = 2},
    [14] = {shopType = 'clothing', coords = vector3(-1207.326, -1458.287, 4.3515658), width = 2, length = 2},
    [15] = {shopType = 'clothing', coords = vector3(125.76344, -223.7481, 54.557876), width = 2, length = 2},
    [16] = {shopType = 'barber', coords = vector3(-822.1445, -184.9414, 37.568912), width = 2, length = 2},
    [17] = {shopType = 'barber', coords = vector3(134.79151, -1708.121, 29.291625), width = 2, length = 2},
    [18] = {shopType = 'barber', coords = vector3(-1284.254, -1115.739, 6.9901146), width = 2, length = 2},
    [19] = {shopType = 'barber', coords = vector3(1931.103, 3728.3391, 32.844413), width = 2, length = 2},
    [20] = {shopType = 'barber', coords = vector3(1211.4759, -470.9031, 66.207984), width = 2, length = 2},
    [21] = {shopType = 'barber', coords = vector3(-31.06776, -151.5832, 57.076553), width = 2, length = 2},
    [22] = {shopType = 'barber', coords = vector3(-278.0236, 6230.3564, 31.695537), width = 2, length = 2}
}
