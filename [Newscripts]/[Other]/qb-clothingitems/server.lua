...
QBCore.Commands.Add(Config.chain, Lang:t("description.torso_description"), {}, false, function(source)
	local prop = false
	local clothe_id = 7
	TriggerClientEvent("jotadateta:client:getclothes2", source, clothe_id, prop)
end, 'user')

QBCore.Commands.Add(Config.mask, Lang:t("description.torso_description"), {}, false, function(source)
	local prop = false
	local clothe_id = 1
	TriggerClientEvent("jotadateta:client:getclothes4", source, clothe_id, prop)
end, 'user')
-------------------
---- Props --------
-------------------
...
QBCore.Commands.Add(Config.glasses, Lang:t("description.torso_description"), {}, false, function(source)
	local prop = true
	local clothe_id = 1
	TriggerClientEvent("jotadateta:client:getclothes3", source, clothe_id, prop)
end, 'user')
