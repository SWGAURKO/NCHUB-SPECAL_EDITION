...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    PlayerJob = QBCore.Functions.GetPlayerData().job
    TriggerServerEvent("qb-10system:add")
end)
...
AddEventHandler('QBCore:Client:OnJobUpdate', function(JobInfo)
    PlayerJob = JobInfo
    TriggerServerEvent("qb-10system:add")
    if PlayerJob.name ~= "police" and PlayerJob.name ~= "ambulance" and PlayerJob.name ~= "corrections" then
        --print("hide")
...
RegisterNetEvent('qb-10system:update')
AddEventHandler('qb-10system:update', function(data)
...
RegisterNetEvent('qb-10system:open')
AddEventHandler('qb-10system:open', function()
    SendNUIMessage({action = "open"})
    SetNuiFocus(true, true)
end)

RegisterNetEvent('qb-10system:sendError')
AddEventHandler('qb-10system:sendError', function(text)
...
RegisterNUICallback("action", function(data,cb)
    TriggerServerEvent('qb-10system:action',data.data)
    cb('ok')
end)
...
RegisterNUICallback("ToggleOpen", function(data,cb)
    if not data.toggle then
        ...
        TriggerServerEvent("qb-10system:remove")
    end
    cb('ok')
end)
...
RegisterNUICallback("rank", function(data,cb)
    TriggerServerEvent('qb-10system:rank',data.rank)
end)
...
RegisterCommand("plist",function()
	...
	if PlayerJob.name == "police" or PlayerJob.name == "ambulance" or PlayerJob.name == "corrections" then
		TriggerEvent("qb-10system:open")
	end
end)
