...
Config.Settings = {
    ...
    ["addXP"] = {min = 10, max = 25}, -- The amount of xp to be given after fishing
    ["addxpafterXcatch"] = 1, -- How many successful catch after exp awards will be given
...
Config.buyMarketItems = { -- LIST OF ITEMS SOLD IN THE FISH MARKET (BUY MENU)
    {itemId = 1, itemName = "fishingrod1", itemLabel = "Fishingrod 1Lv.", itemPrice = 1000, image = './css/imgs/fishingrod.png'},
    {itemId = 2, itemName = "fishbait", itemLabel = "Fish Bait", itemPrice = 15, image = './css/imgs/fishbait.png'},
...
Config.Zones = { -- FISHING AREAS
    { -- Motel
        coords = vector3(-1950.628, -1350.404, 9.9225063), -- FISHING AREA COORDINATES
...
Config.Tasks = { -- TASKS APPEARING ON THE FISH MENU
    {
        ...
        moneyRewards = 100, -- TASK'S PRIZE MONEY
    ...
    },
    {
        ...
        moneyRewards = 225, -- TASK'S PRIZE MONEY
        xpRewards = 500, -- TASK'S XP REWARD
    ...
    },
    {
        ...
        moneyRewards = 475, -- TASK'S PRIZE MONEY
        xpRewards = 500, -- TASK'S XP REWARD
    ...
    },
    {
        ...
        moneyRewards = 725, -- TASK'S PRIZE MONEY
        xpRewards = 500, -- TASK'S XP REWARD
    ...
    },
    {
        ...
        moneyRewards = 1250, -- TASK'S PRIZE MONEY
        xpRewards = 500, -- TASK'S XP REWARD
    ...
    },
    {
        ...
        moneyRewards = 2500, -- TASK'S PRIZE MONEY
        xpRewards = 500, -- TASK'S XP REWARD
        requiredCount = 20, -- NUMBER OF FISH CATCHES REQUIRED TO COMPLETE THE TASK
        taskDescription = "Receive your reward after successfully completing the mission.",
    },
