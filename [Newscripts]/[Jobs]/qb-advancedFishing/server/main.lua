...
Citizen.CreateThread(function()
    ...
    for k, v in pairs(Config.fishingRods) do 
        QBCore.Functions.CreateUseableItem(v.itemName, function(source, item)
            TriggerClientEvent('qb-advancedFishing:start', source, v.level)
        end)
    end
    
    for x, z in pairs(Config.fishBaits) do 
        QBCore.Functions.CreateUseableItem(z.itemName, function(source, item)
            TriggerClientEvent('qb-advancedFishing:setBait', source, z.baitType, z.itemName, z.label)
        end)
    end
...
QBCore.Functions.CreateCallback('qb-advancedFishing:getPlayerDetails', function(source, cb)
...
QBCore.Functions.CreateCallback('qb-advancedFishing:rewards', function(source, cb, data)
    local _source = source
    local xPlayer = QBCore.Functions.GetPlayer(_source)
    local citizenId = xPlayer.PlayerData.citizenid
...
RegisterNetEvent('qb-advancedFishing:addTaskCount')
AddEventHandler('qb-advancedFishing:addTaskCount', function(itemName)
    local src = source
...
QBCore.Functions.CreateCallback('qb-advancedFishing:addXP', function(source, cb, amount)
    local _source = source
    local xPlayer = QBCore.Functions.GetPlayer(_source)
    local citizenId = xPlayer.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('qb-advancedFishing:upgradeRod', function(source, cb, data)
    local src = source
...
QBCore.Functions.CreateCallback('qb-advancedFishing:buyItem', function(source, cb, data)
    local src = source
    local xPlayer = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('qb-advancedFishing:sellItem', function(source, cb, data)
    local src = source
    local xPlayer = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent('qb-advancedFishing:addItem')
AddEventHandler('qb-advancedFishing:addItem', function(item)
    local src = source
    local xPlayer = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('qb-advancedFishing:removeBait')
AddEventHandler('qb-advancedFishing:removeBait', function(item)
    local xPlayer = QBCore.Functions.GetPlayer(source)
