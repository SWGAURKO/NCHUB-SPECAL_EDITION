...
Config.Boosting.HackingDevice = "transponder" -- Whatever item you use to hack a car with

Config.Boosting.HackDelayMin = 15 -- Seconds
Config.Boosting.HackDelayMax = 40 -- Seconds


Config.Boosting.Frequency = 30 -- Whats the max time for a boost ping for cops? - Standard 30 seconds
