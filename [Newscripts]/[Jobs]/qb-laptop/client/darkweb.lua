...
local function openCrate(crate)
    ...
    QBCore.Functions.TriggerCallback('qb-laptop:server:getCrateStatus', function(data)
...
RegisterNUICallback('darkweb/items', function(source)
    TriggerEvent("glow_blackmarket_cl:openUI", source)
end)
...
local function breakCrate(entity)
    if haveItem('drill') then
        exports['ps-ui']:Thermite(function(success)
            if success then
                TriggerServerEvent('qb-laptop:server:crateOpened', NetworkGetNetworkIdFromEntity(entity))
...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    QBCore.Functions.TriggerCallback('qb-laptop:server:getAllCrates', function(crateInfo)
        crates = crateInfo
...
RegisterNetEvent('qb-laptop:client:updateCrates', function(crateInfo)
    crates = crateInfo
end)
