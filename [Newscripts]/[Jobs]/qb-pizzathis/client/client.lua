...
CreateThread(function()
	...
	Targets["PizzTray"] =
	exports['qb-target']:AddBoxZone("PizzTray", vector3(-1344.862, -1065.422, 7.2822449), 0.6, 1.6, { name="PizzTray", heading = 0.0, debugPoly=Config.Debug, minZ = 6.28, maxZ = 8.28, },
		{ options = { {  event = "qb-pizzathis:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["toppings_tray"], stash = "Toppings", job = "pizzathis" }, }, distance = 1.0 })

	Targets["PizzBase"] =
	exports['qb-target']:AddBoxZone("PizzBase", vector3(-1337.087, -1059.077, 7.3797767), 0.4, 0.4, { name="PizzBase", heading = 0.0, debugPoly=Config.Debug, minZ = 6.58, maxZ = 8.18, },
		{ options = { {  event = "qb-pizzathis:Crafting", icon = "fas fa-pizza-slice", label = Loc[Config.Lan].targetinfo["prepare_pizza"], job = "pizzathis", craftable = Crafting.Base, header = Loc[Config.Lan].menu["pizza_base"], coords = vector3(-1337.087, -1059.077, 7.3797767) }, }, distance = 1.0 })

	Targets["PizzDough"] =
	exports['qb-target']:AddBoxZone("PizzDough", vector3(-1339.897, -1062.728, 7.2976868), 1.2, 3.2, { name="PizzDough", heading = 0.0, debugPoly=Config.Debug, minZ = 6.28, maxZ = 8.28, },
		{ options = { {  event = "qb-pizzathis:JustGive", icon = "fas fa-cookie", label = Loc[Config.Lan].targetinfo["prepare_dough"], job = "pizzathis", id = "pizzadough", coords = vector3(-1339.897, -1062.728, 7.2976868) }, }, distance = 1.0 })

	Targets["PizzOven"] =
	exports['qb-target']:AddBoxZone("PizzOven", vector3(-1338.289, -1061.726, 7.35443), 2.8, 0.7, { name="PizzOven", heading = 0.0, debugPoly=Config.Debug, minZ = 6.39, maxZ = 8.39, },
		{ options = { {  event = "qb-pizzathis:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_oven"], job = "pizzathis", craftable = Crafting.Oven, header = Loc[Config.Lan].menu["oven_menu"], coords = vector3(-1338.289, -1061.726, 7.35443) }, }, distance = 1.0 })

	Targets["PizzChop"] =
	exports['qb-target']:AddBoxZone("PizzChop", vector3(-1337.024, -1060.984, 7.4907014), 0.6, 0.6, { name="PizzChop", heading = 0.0, debugPoly=Config.Debug, minZ = 6.18, maxZ = 8.38, },
		{ options = { {  event = "qb-pizzathis:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["chopping_board"], job = "pizzathis", craftable = Crafting.ChoppingBoard, header = Loc[Config.Lan].menu["chopping_board"], coords = vector3(-1337.024, -1060.984, 7.4907014)}, }, distance = 1.0	})
	...
	exports['qb-target']:AddBoxZone("PizzChop2", vector3(809.26, -761.19, 26.78), 0.55, 0.4, { name="PizzChop2", heading = 10.0, debugPoly=Config.Debug, minZ = 26.18, maxZ = 27.38, },
		{ options = { { event = "qb-pizzathis:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["chopping_board"], job = "pizzathis", craftable = Crafting.ChoppingBoard, header = Loc[Config.Lan].menu["chopping_board"], coords = vector3(809.26, -761.19, 26.78) }, }, distance = 1.0	})

	Targets["PizzBurner"] =
	exports['qb-target']:AddBoxZone("PizzBurner", vector3(-1341.339, -1060.205, 7.9560703), 2.4, 1.2, { name="PizzBurner", heading = 0.0, debugPoly=Config.Debug, minZ = 5.98, maxZ = 8.98, },
		{ options = { { event = "qb-pizzathis:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["stone_oven"],"Use Stone Oven", job = "pizzathis", craftable = Crafting.PizzaOven, header = Loc[Config.Lan].menu["stone_pizza"], coords = vector3(-1341.339, -1060.205, 7.9560703) }, }, distance = 1.0 })

	Targets["PizzWine"] =
	exports['qb-target']:AddBoxZone("PizzWine", vector3(-1347.544, -1065.422, 7.9928905), 0.4, 1.7, { name="PizzWine", heading = 0.0, debugPoly=Config.Debug, minZ = 6.9, maxZ = 8.9, },
		{ options = { {  event = "qb-pizzathis:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["wine_rack"], job = "pizzathis", shop = Config.WineItems, coords = vector3(-1347.544, -1065.422, 7.9928905) }, }, distance = 1.5 })
	Targets["PizzWine2"] =
	exports['qb-target']:AddBoxZone("PizzWine2", vector3(807.25, -761.79, 22.3), 0.4, 1.7, { name="PizzWine", heading = 0.0, debugPoly=Config.Debug, minZ = 21.3, maxZ = 22.9, },
		{ options = { {  event = "qb-pizzathis:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["wine_rack"], job = "pizzathis", shop = Config.WineItems, coords = vector3(807.25, -761.79, 22.3) }, }, distance = 1.5 })

	Targets["PizzFridge"] =
	exports['qb-target']:AddBoxZone("PizzFridge", vector3(-1345.454, -1062.513, 7.0255303), 0.6, 0.6, { name="PizzFridge", heading = 0.0, debugPoly=Config.Debug, minZ=5.98, maxZ=7.83 },
		{ options = { {  event = "qb-pizzathis:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["drink_fridge"], job = "pizzathis", shop = Config.DrinkItems, coords = vector3(-1345.454, -1062.513, 7.0255303) }, }, distance = 1.5 })
	Targets["PizzFridge2"] =
	exports['qb-target']:AddBoxZone("PizzFridge2", vector3(814.07, -748.64, 26.78), 0.6, 0.6, { name="PizzFridge2", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=26.83 },
		{ options = { {  event = "qb-pizzathis:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["drink_fridge"], job = "pizzathis", shop = Config.DrinkItems, coords = vector3(814.07, -748.64, 26.78) }, }, distance = 1.5 })
	Targets["PizzFridge3"] =
	exports['qb-target']:AddBoxZone("PizzFridge3", vector3(-1347.576, -1063.36, 7.5435709), 1.6, 0.6, { name="PizzFridge3", heading = 0.0, debugPoly=Config.Debug, minZ = 6.5435709, maxZ = 8.5435709, },
		{ options = { {  event = "qb-pizzathis:Shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["food_fridge"],  job = "pizzathis", shop = Config.FoodItems, coords = vector3(805.68, -761.62, 26.78) }, }, distance = 2.0 })
	Targets["PizzFreezer"] =
	exports['qb-target']:AddBoxZone("PizzFreezer", vector3(-1344.923, -1062.11, 6.9067578), 0.6, 4.0, { name="PizzFreezer", heading = 0.0, debugPoly=Config.Debug, minZ = 6.9067578, maxZ = 7.9067578, },
		{ options = { {  event = "qb-pizzathis:Shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_freezer"], job = "pizzathis", shop = Config.FreezerItems, coords = vector3(802.75, -756.85, 26.78) }, }, distance = 1.0 })

	Targets["PizzWash1"] =
	exports['qb-target']:AddBoxZone("PizzWash1", vector3(-1338.485, -1058.086, 7.1495629), 0.6, 0.8, { name="PizzWash1", heading = 0.0, debugPoly=Config.Debug, minZ = 6.38, maxZ = 8.38, },
		{ options = { { event = "qb-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], coords = vector3(-1338.485, -1058.086, 7.3495629) }, }, distance = 1.5 })
	Targets["PizzWash2"] =
	exports['qb-target']:AddBoxZone("PizzWash2", vector3(-1342.328, -1061.009, 7.3740572), 0.8, 0.6, { name="PizzWash2", heading = 0.0, debugPoly=Config.Debug, minZ = 6.38, maxZ = 8.38, },
		{ options = { { event = "qb-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], coords = vector3(-1342.328, -1061.009, 7.1740572) }, }, distance = 1.5 })
	Targets["PizzWash3"] =
	exports['qb-target']:AddBoxZone("PizzWash3", vector3(813.35, -755.46, 26.78), 0.4, 0.8, { name="PizzWash3", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.38, },
		{ options = { { event = "qb-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], coords = vector3(813.35, -755.46, 26.78) }, }, distance = 1.2 })
	Targets["PizzWash4"] =
	exports['qb-target']:AddBoxZone("PizzWash4", vector3(800.88, -767.88, 26.78), 0.8, 0.6, { name="PizzWash4", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.38, },
		{ options = { { event = "qb-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = "pizzathis", coords = vector3(800.88, -767.88, 26.78) }, }, distance = 1.5 })
	Targets["PizzWash5"] =
	exports['qb-target']:AddBoxZone("PizzWash5", vector3(800.85, -767.07, 26.78), 0.8, 0.6, { name="PizzWash5", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.38, },
		{ options = { { event = "qb-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], coords = vector3(800.85, -767.07, 26.78) }, }, distance = 1.5 })
	Targets["PizzWash6"] =
	exports['qb-target']:AddBoxZone("PizzWash6", vector3(800.85, -761.18, 26.78), 0.8, 0.6, { name="PizzWash6", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.38, },
		{ options = { { event = "qb-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], coords = vector3(800.85, -761.18, 26.78) }, }, distance = 1.2 })
	Targets["PizzWash7"] =
	exports['qb-target']:AddBoxZone("PizzWash7", vector3(800.89, -762.04, 26.78), 0.8, 0.6, { name="PizzWash7", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.38, },
		{ options = { { event = "qb-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], coords = vector3(800.89, -762.04, 26.78) }, }, distance = 1.2 })
	Targets["PizzWash8"] =
	exports['qb-target']:AddBoxZone("PizzWash8", vector3(809.9, -765.32, 31.27), 0.6, 0.6, { name="PizzWash8", heading = 0.0, debugPoly=Config.Debug, minZ=30.67, maxZ=31.67 },
		{ options = { { event = "qb-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], coords = vector3(809.9, -765.32, 31.27) }, }, distance = 1.2 })
	Targets["PizzWash9"] =
	exports['qb-target']:AddBoxZone("PizzWash9", vector3(808.91, -765.34, 31.27), 0.6, 0.6, { name="PizzWash9", heading = 0.0, debugPoly=Config.Debug, minZ=30.67, maxZ=31.67 },
		{ options = { { event = "qb-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], coords = vector3(808.91, -765.34, 31.27) }, }, distance = 1.2 })
	...
	exports['qb-target']:AddBoxZone("PizzCounter", vector3(810.98, -752.9, 26.78), 0.6, 0.6, { name="PizzCounter", heading = 9.0, debugPoly=Config.Debug, minZ = 26.78, maxZ = 27.58, },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "CounterRight", coords = vector3(810.98, -752.9, 26.78) }, }, distance = 2.0 })
	...
	exports['qb-target']:AddBoxZone("PizzCounter2", vector3(810.93, -749.92, 26.78), 0.7, 0.7, { name="PizzCounter2", heading = 30.0, debugPoly=Config.Debug, minZ = 26.78, maxZ = 27.58, },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "CounterLeft", coords = vector3(810.93, -749.92, 26.78) }, }, distance = 2.0 })
	...
	exports['qb-target']:AddBoxZone("PizzReceipt", vector3(811.32, -750.77, 26.78), 0.7, 0.35, { name="PizzReceipt", heading = 0.0, debugPoly=Config.Debug, minZ = 26.78, maxZ = 27.18, },
		{ options = { { event = "qb-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "pizzathis", coords = vector3(811.32, -750.77, 26.78),
	...
	exports['qb-target']:AddBoxZone("PizzReceipt2", vector3(811.29, -752.09, 26.78), 0.7, 0.35, { name="PizzReceipt2", heading = 0.0, debugPoly=Config.Debug, minZ = 26.78, maxZ = 27.18, },
		{ options = { { event = "qb-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "pizzathis", coords = vector3(811.29, -752.09, 26.78),
						img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/5/59/PizzaThis.png width=200px></p>",
		} }, distance = 2.0	})

	Targets["PizzTap"] =
	exports['qb-target']:AddBoxZone("PizzTap", vector3(-1343.482, -1060.852, 7.5970356), 0.9, 0.6, { name="PizzTap", heading = 0.0, debugPoly=Config.Debug, minZ = 6.78, maxZ = 8.48, },
		{ options = { { event = "qb-pizzathis:Crafting", icon = "fas fa-beer", label = Loc[Config.Lan].targetinfo["pour_beer"], job = "pizzathis", craftable = Crafting.Beer, header = Loc[Config.Lan].menu["beer_menu"], coords = vector3(-1343.482, -1060.852, 7.5970356) }, }, distance = 1.5 })

	Targets["PizzCoffee"] =
	exports['qb-target']:AddBoxZone("PizzCoffee",vector3(-1346.096, -1062.769, 7.7535719), 0.6, 0.6, { name="PizzCoffee", heading = 0.0, debugPoly=Config.Debug, minZ = 5.58, maxZ = 7.58, },
		{ options = { { event = "qb-pizzathis:JustGive", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["pour_coffee"], job = "pizzathis", id = "coffee", coords = vector3(-1346.096, -1062.769, 7.7535719)}, }, distance = 2.0 })
	Targets["PizzCoffee2"] =
	exports['qb-target']:AddBoxZone("PizzCoffee2", vector3(811.49, -764.82, 26.78), 1.6, 0.63, { name="PizzCoffee2", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.58, },
		{ options = { { event = "qb-pizzathis:JustGive", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["pour_coffee"], job = "pizzathis", id = "coffee", coords = vector3(811.49, -764.82, 26.78)}, }, distance = 2.0 })
	...
	exports['qb-target']:AddBoxZone("PizzTable", vector3(807.08, -751.57, 26.78), 1.0, 1.0, { name="PizzTable", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table1" }, }, distance = 2.0 })
	Targets["PizzTable2"] =
	exports['qb-target']:AddBoxZone("PizzTable2", vector3(803.13, -751.59, 26.78), 1.0, 1.0, { name="PizzTable2", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table2" }, }, distance = 2.0 })
	Targets["PizzTable3"] =
	exports['qb-target']:AddBoxZone("PizzTable3", vector3(799.13, -751.57, 26.78), 1.0, 1.0, { name="PizzTable3", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table3" }, }, distance = 2.0 })
	Targets["PizzTable4"] =
	exports['qb-target']:AddBoxZone("PizzTable4", vector3(797.96, -748.86, 26.78), 1.0, 1.0, { name="PizzTable4", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table4" }, }, distance = 2.0 })
	Targets["PizzTable5"] =
	exports['qb-target']:AddBoxZone("PizzTable5", vector3(795.25, -751.55, 26.78), 1.0, 1.0, { name="PizzTable5", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table5" }, }, distance = 2.0 })
	Targets["PizzTable6"] =
	exports['qb-target']:AddBoxZone("PizzTable6", vector3(799.46, -755.04, 26.78), 1.0, 1.0, { name="PizzTable6", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table6" }, }, distance = 2.0 })
	Targets["PizzTable7"] =
	exports['qb-target']:AddBoxZone("PizzTable7", vector3(807.71, -754.9, 26.78), 2.0, 0.8, { name="PizzTable7", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table7" }, }, distance = 2.0 })
	Targets["PizzTable8"] =
	exports['qb-target']:AddBoxZone("PizzTable8", vector3(805.61, -754.89, 26.78), 2.0, 0.8, { name="PizzTable8", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table8" }, }, distance = 2.0 })
	Targets["PizzTable9"] =
	exports['qb-target']:AddBoxZone("PizzTable9", vector3(803.51, -754.9, 26.78), 2.0, 0.8, { name="PizzTable9", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table9" }, }, distance = 2.0 })
	Targets["PizzTable10"] =
	exports['qb-target']:AddBoxZone("PizzTable10", vector3(801.42, -754.93, 26.78), 2.0, 0.8, { name="PizzTable10", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table10" }, }, distance = 2.0 })
	Targets["PizzTable11"] =
	exports['qb-target']:AddBoxZone("PizzTable11", vector3(799.32, -757.63, 26.78), 0.8, 1.4, { name="PizzTable11", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table11" }, }, distance = 2.0 })
	Targets["PizzTable12"] =
	exports['qb-target']:AddBoxZone("PizzTable12", vector3(799.32, -759.72, 26.78), 0.8, 1.4, { name="PizzTable12", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 },
		{ options = { { event = "qb-pizzathis:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_table"], stash = "Table12" }, }, distance = 2.0 })
...
RegisterNetEvent('qb-pizzathis:washHands', function(data)
	lookEnt(data.coords)
...
RegisterNetEvent('qb-pizzathis:Shop', function(data)
...
RegisterNetEvent('qb-pizzathis:Stash', function(data)	lookEnt(data.coords) TriggerServerEvent("inventory:server:OpenInventory", "stash", "pizza_"..data.stash) TriggerEvent("inventory:client:SetCurrentStash", "pizza_"..data.stash) end)
...
function FoodProgress(ItemMake)
	...
	{ animDict = animDictNow, anim = animNow, flags = 8, },	{}, {}, function()
		TriggerServerEvent('qb-pizzathis:Crafting:GetItem', ItemMake)
...
RegisterNetEvent('qb-pizzathis:JustGive', function(data)
	if not jobCheck() then return end
	lookEnt(data.coords)
	FoodProgress(data.id)
end)

RegisterNetEvent('qb-pizzathis:Crafting:MakeItem', function(data)
	local bartext = ""
	bartime = 7000
	animDictNow = "anim@heists@prison_heiststation@cop_reactions"
	animNow = "cop_b_idle"
	...
	{}, {}, function()
		TriggerServerEvent('qb-pizzathis:Crafting:GetItem', data.item, data.craft)
		Wait(500)
		TriggerEvent("qb-pizzathis:Crafting", data)
	end, function() -- Cancel
		TriggerEvent('inventory:client:busy:status', false)
	end, data.item)
end)

RegisterNetEvent('qb-pizzathis:Crafting', function(data)
	if not jobCheck() then return end
	local Menu = {}
	...
	for i = 1, #data.craftable do
		for k, v in pairs(data.craftable[i]) do
			if k ~= "amount" then
				...
				Menu[#Menu + 1] = { disabled = disable, icon = k, header = setheader, txt = settext, params = { event = "qb-pizzathis:Crafting:MakeItem", args = { item = k, craft = data.craftable[i], craftable = data.craftable, header = data.header } } }
