	...
	for k, v in pairs(Config.Locations) do
		...
		if v.zoneEnable then
			...
			if k == "beangabzlegion" then
				Targets["BeanWash"] =
					exports['qb-target']:AddBoxZone("BeanWash", vector3(-1200.351, -1139.322, 7.8332743), 1.2, 0.8, { name="BeanWash", heading = 340.0, debugPoly=Config.Debug, minZ=6.88, maxZ=8.68 },
						{ options = { { event = "qb-coolbeans:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = v.job, coords = vec3(123.73, -1039.24, 29.28) }, }, distance = 1.5 })
						Targets["BeanWash"] =
						exports['qb-target']:AddBoxZone("BeanWash2", vector3(-1198.467, -1145.888, 7.8280601), 1.2, 0.8, { name="BeanWash2", heading = 340.0, debugPoly=Config.Debug, minZ=6.8280601, maxZ=8.8280601 },
							{ options = { { event = "qb-coolbeans:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = v.job, coords = vec3(123.73, -1039.24, 29.28) }, }, distance = 1.5 })
				Targets["BeanCounter"] =
					exports['qb-target']:AddBoxZone("BeanCounter", vector3(-1198.897, -1135.957, 7.4023761), 0.7, 1.2, { name="BeanCounter", heading = 340.0, debugPoly=Config.Debug, minZ=6.4, maxZ=8.48 },
						{ options = { { event = "qb-coolbeans:Stash", icon = "fas fa-mug-saucer", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter", coords = vec3(120.54, -1040.74, 29.28) }, }, distance = 2.0 })
				...
				-- 		{ options = { { event = "qb-coolbeans:Stash", icon = "fas fa-mug-saucer", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter2", coords = vec3(121.85, -1037.08, 29.28) }, }, distance = 2.0 })
				...
				-- 		img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/f/fc/Thecoolbeans-GTA4-logo.png width=100px></p>"
				-- 		} }, distance = 2.0 })
				...
				Targets["BeanFridge"] =
					exports['qb-target']:AddBoxZone("BeanFridge", vector3(-1196.879, -1141.817, 8.1863431), 0.85, 0.6, { name="BeanFridge", heading = 340.0, debugPoly=Config.Debug, minZ=7.1863431, maxZ=9.1863431 },
						{ options = { {  event = "qb-coolbeans:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_storage"], job = v.job, shop = Config.FoodItems, shopname = "BeanFridge", coords = vec3(124.51, -1037.97, 29.28) }, }, distance = 1.5 })
				-- Targets["BeanFridge2"] =
				...
				-- 		{ options = { {  event = "qb-coolbeans:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_storage"], job = v.job, shop = Config.FoodItems, shopname = "BeanFridge2", coords = vec3(123.5, -1040.74, 29.28) }, }, distance = 1.5 })

				Targets["BeanDrink"] =
					exports['qb-target']:AddBoxZone("BeanDrink", vector3(-1195.964, -1143.115, 8.1658587), 0.86, 0.8, { name="BeanDrink", heading = 340.0, debugPoly=Config.Debug, minZ=7.1658587, maxZ=9.1658587 },
						{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_coffee"], job = v.job, craftable = Crafting.Drinks, header = Loc[Config.Lan].menu["drink_menu"], coords = vec3(124.56, -1036.88, 29.28) }, }, distance = 2.0 })
				-- Targets["BeanDrink2"] =
				...
				-- 		{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_coffee"], job = v.job, craftable = Crafting.Drinks, header = Loc[Config.Lan].menu["drink_menu"], coords = vec3(122.93, -1041.68, 29.28) }, }, distance = 2.0 })

				Targets["BeanSlush"] =x
					exports['qb-target']:AddBoxZone("BeanSlush", vector3(-1201.052, -1146.169, 8.3249688), 0.8, 0.8, { name="BeanSlush", heading = 340.0, debugPoly=Config.Debug, minZ=7.3249688, maxZ=9.3249688 },
						{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-cocktail", label = Loc[Config.Lan].targetinfo["prepare_slush"], job = v.job, craftable = Crafting.Slush, header = Loc[Config.Lan].menu["slush_menu"], coords = vec3(126.07, -1036.59, 29.28) }, }, distance = 2.0 })

				Targets["BeanSoda"] =
					exports['qb-target']:AddBoxZone("BeanSoda", vector3(-1198.729, -1138.396, 7.8332571), 1.3, 1.4, { name="BeanSoda", heading = 340.0, debugPoly=Config.Debug, minZ=6.7, maxZ=8.8 },
						{ options = { { event = "qb-coolbeans:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["grab_soda"], job = v.job, shop = Config.SodaItems, shopname = "BeanSoda", coords = vec3(123.56, -1042.75, 29.28) }, }, distance = 2.0 })

				Targets["donut"] =
					exports['qb-target']:AddBoxZone("donut", vector3(-1202.291, -1138.176, 7.8332724), 1.45, 0.9, { name="donut", heading = 340.0, debugPoly=Config.Debug, minZ=6.7, maxZ=8.8 },
						{ options = { { event = "qb-coolbeans:Shop", icon = "fas fa-circle-dot", label = Loc[Config.Lan].targetinfo["grab_food"], job = v.job, shop = Config.DesertItems, shopname = "donut", coords = vec3(121.4, -1038.43, 29.28) },
									{ event = "qb-coolbeans:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_stash"], job = v.job, stash = "LegionStash", coords = vec3(121.4, -1038.43, 29.28) }, }, distance = 2.0 })

				Targets["BeanClockin"] =
					exports['qb-target']:AddBoxZone("BeanClockin", vector3(0, 0, 0), 1.2, 0.5, { name="BeanClockin", heading = 340.0, debugPoly=Config.Debug, minZ=6.28, maxZ=8.28 },
			...
			if k == "beanunclejust" then
				...
				Targets["UBeanCounter"] =
					exports['qb-target']:AddBoxZone("UBeanCounter", vec3(-634.27, 234.69, 81.88), 0.55, 0.4, { name="UBeanCounter", heading = 5.0, debugPoly=Config.Debug, minZ=81.93, maxZ=82.48 },
						{ options = { { event = "qb-coolbeans:Stash", icon = "fas fa-mug-saucer", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "UCounter", coords = vec3(-634.27, 234.69, 81.88) }, }, distance = 2.0 })
				...
				Targets["UBeanDrink"] =
					exports['qb-target']:AddBoxZone("UBeanDrink", vec3(-635.7, 236.55, 81.88), 0.6, 1.0, { name="UBeanDrink", heading = 1.0, debugPoly=Config.Debug, minZ=81.88, maxZ=82.68 },
						{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_coffee"], job = v.job, craftable = Crafting.Drinks, header = Loc[Config.Lan].menu["drink_menu"], coords = vec3(-635.7, 236.55, 81.88) }, }, distance = 2.0 })
				Targets["UBeanDrink2"] =
					exports['qb-target']:AddBoxZone("UBeanDrink2", vec3(-627.68, 222.8, 81.88), 0.6, 0.8, { name="UBeanDrink2", heading = 0.0, debugPoly=Config.Debug, minZ=81.88, maxZ=82.68 },
						{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_coffee"], job = v.job, craftable = Crafting.Drinks, header = Loc[Config.Lan].menu["drink_menu"], coords = vec3(-627.68, 222.8, 81.88) }, }, distance = 2.0 })
				Targets["UBeanFridge"] =
					exports['qb-target']:AddBoxZone("UBeanFridge", vec3(-635.51, 233.23, 81.88-1), 0.4, 1.6, { name="UBeanFridge", heading = 339.0, debugPoly=Config.Debug, minZ=80.88, maxZ=83.08 },
						{ options = { { event = "qb-coolbeans:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_shop"], job = v.job, shop = Config.FoodItems, coords = vec3(-635.51, 233.23, 81.88), shopname = "UBeanFridge", },
									{ event = "qb-coolbeans:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_stash"], job = v.job, stash = "UStash", coords = vec3(-635.51, 233.23, 81.88) }, }, distance = 1.5 })
				Targets["UBeanSlush"] =
					exports['qb-target']:AddBoxZone("UBeanSlush", vec3(-636.52, 235.81, 81.88), 0.5, 0.5, { name="UBeanSlush", heading = 1.0, debugPoly=Config.Debug, minZ=82.28, maxZ=83.08 },
						{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-cocktail", label = Loc[Config.Lan].targetinfo["prepare_slush"], job = v.job, craftable = Crafting.Slush, header = Loc[Config.Lan].menu["slush_menu"], coords = vec3(-636.52, 235.81, 81.88) }, }, distance = 2.0 })
				Targets["UBeanSoda"] =
					exports['qb-target']:AddBoxZone("UBeanSoda", vec3(-636.74, 234.86, 81.88-1), 2.6, 0.4, { name="UBeanSoda", heading = 1.0, debugPoly=Config.Debug, minZ=80.88, maxZ=82.08 },
						{ options = { { event = "qb-coolbeans:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["grab_soda"], job = v.job, shop = Config.SodaItems, shopname = "UBeanSoda", coords = vec3(-636.74, 234.86, 81.88) }, }, distance = 2.0 })
				Targets["Udonut"] =
					exports['qb-target']:AddBoxZone("Udonut", vec3(-636.62, 234.98, 81.88), 0.6, 0.6, { name="Udonut", heading = 1.0, debugPoly=Config.Debug, minZ=82.28, maxZ=82.88 },
					{ options = { { event = "qb-coolbeans:Shop", icon = "fas fa-circle-dot", label = Loc[Config.Lan].targetinfo["grab_food"], job = v.job, shop = Config.DesertItems, shopname = "Udonut", coords = vec3(-636.62, 234.98, 81.88) }, }, distance = 2.0 })
				Targets["UBeanWash"] =
					exports['qb-target']:AddBoxZone("UBeanWash", vec3(-621.67, 226.77, 81.88-1), 1.6, 0.6, { name="BeanWash", heading = 0.0, debugPoly=Config.Debug, minZ=80.88, maxZ=82.68 },
						{ options = { { event = "qb-coolbeans:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = v.job, coords = vec3(-621.67, 226.77, 81.88) }, }, distance = 1.5 })
				Targets["UBeanWash2"] =
					exports['qb-target']:AddBoxZone("UBeanWash2", vec3(-630.71, 222.83, 81.88-1), 0.7, 1.4, { name="UBeanWash2", heading = 0.0, debugPoly=Config.Debug, minZ=80.88, maxZ=82.68 },
						{ options = { { event = "qb-coolbeans:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = v.job, coords = vec3(-630.71, 222.83, 81.88) }, }, distance = 1.5 })

				Targets["UBeanClockin"] =
					exports['qb-target']:AddBoxZone("UBeanClockin", vec3(0, 0, 0), 1.6, 0.2, { name="UBeanClockin", heading = 0.0, debugPoly=Config.Debug, minZ=81.68, maxZ=82.93 },
					{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = v.job },
			...
			if k == "beanrflx" then
				Targets["flxClockin"] =
					exports['qb-target']:AddBoxZone("flxClockin", vec3(0, 0, 0), 0.5, 0.5, { name="flxClockin", heading = 343.0, debugPoly=Config.Debug, minZ=29.02, maxZ=29.62 },
					{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = v.job },
								{ event = "qb-bossmenu:client:OpenMenu", icon = "fas fa-list", label = "Open Bossmenu", job = bossroles, },
								}, distance = 2.0 })
				Targets["flxReceipt"] =
				...
				Targets["flxCounter"] =
					...
					{ options = { { event = "qb-coolbeans:Stash", icon = "fas fa-mug-saucer", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "flxCounter", coords = vec3(280.50, -972.54, 30.29) }, }, distance = 2.0 })
				Targets["flxBeanSlush"] =
					exports['qb-target']:AddBoxZone("flxBeanSlush", vec3(278.92, -972.6, 30.62-1), 0.5, 0.5, { name="flxBeanSlush", heading = 90.0, debugPoly=Config.Debug, minZ=29.42, maxZ=30.52 },
						{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-cocktail", label = Loc[Config.Lan].targetinfo["prepare_slush"], job = v.job, craftable = Crafting.Slush, header = "Slush Menu", coords = vec3(278.92, -972.6, 30.62) }, }, distance = 2.0 })
				Targets["flxBeanSoda"] =
					exports['qb-target']:AddBoxZone("flxBeanSoda", vec3(278.87, -973.37, 30.62-1), 0.5, 0.7, { name="flxBeanSoda", heading = 90.0, debugPoly=Config.Debug, minZ=29.42, maxZ=30.22 },
						{ options = { { event = "qb-coolbeans:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["grab_soda"], job = v.job, shop = Config.SodaItems, shopname = "flxBeanSoda", coords = vec3(278.87, -973.37, 30.62) }, }, distance = 2.0 })

				Targets["flxdonut"] =
					exports['qb-target']:AddBoxZone("flxdonut", vec3(279.62, -972.55, 30.62-1), 0.5, 0.7, { name="flxdonut", heading = 90.0, debugPoly=Config.Debug, minZ=29.42, maxZ=30.02 },
							{ options = { { event = "qb-coolbeans:Shop", icon = "fas fa-circle-dot", label = Loc[Config.Lan].targetinfo["grab_food"], job = v.job, shop = Config.DesertItems, shopname = "flxdonut", coords = vec3(279.62, -972.55, 30.62) },
										{ event = "qb-coolbeans:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_stash"], job = v.job, stash = "flxStash", coords = vec3(279.62, -972.55, 30.62) }, }, distance = 2.0 })
				...
				exports['qb-target']:AddBoxZone("flxBeanDrink", vec3(279.54, -975.12, 29.42), 0.7, 0.5, { name="flxBeanDrink", heading = 90.0, debugPoly=Config.Debug, minZ=29.42, maxZ=30.22 },
					{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_coffee"], job = v.job, craftable = Crafting.Drinks, header = "Drinks Menu", coords = vec3(279.54, -975.12, 29.42) }, }, distance = 2.0 })
				Targets["flxBeanFridge"] =
					exports['qb-target']:AddBoxZone("flxBeanFridge", vec3(278.94, -971.89, 29.42-1), 0.85, 0.7, { name="flxBeanFridge", heading = 0.0, debugPoly=Config.Debug, minZ=28.62, maxZ=30.62 },
						{ options = { {  event = "qb-coolbeans:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_storage"], job = v.job, shop = Config.FoodItems, shopname = "flxBeanFridge", coords = vec3(278.94, -971.89, 29.42) }, }, distance = 1.5 })
...
RegisterNetEvent('qb-coolbeans:washHands', function(data)
...
--[[CRAFTING]]--
RegisterNetEvent('qb-coolbeans:Crafting:MakeItem', function(data)
	...
	{ animDict = "mp_ped_interaction", anim = "handshake_guy_a", flags = 8, }, {}, {}, function()
		CraftLock = false
		TriggerServerEvent('qb-coolbeans:Crafting:GetItem', data.item, data.craft)
		Wait(500)
		TriggerEvent("qb-coolbeans:Crafting", data)
	end, function() -- Cancel
		CraftLock = false
...
RegisterNetEvent('qb-coolbeans:Crafting', function(data)
	...
	for i = 1, #data.craftable do
		for k, v in pairs(data.craftable[i]) do
			if k ~= "amount" then
				...
				local event = "qb-coolbeans:Crafting:MakeItem"
                if Config.MultiCraft then event = "qb-coolbeans:Crafting:MultiCraft" end
				Menu[#Menu + 1] = {
					disabled = disable,
...
RegisterNetEvent('qb-coolbeans:Crafting:MultiCraft', function(data)
	...
	Menu[#Menu + 1] = { icon = "fas fa-arrow-left", title = Loc[Config.Lan].menu["back"], header = "", txt = Loc[Config.Lan].menu["back"], params = { event = "qb-coolbeans:Crafting", args = data }, event = "qb-coolbeans:Crafting", args = data }
	for k in pairsByKeys(success) do
		Menu[#Menu + 1] = {
			...
			event = "qb-coolbeans:Crafting:MakeItem", args = { item = data.item, craft = data.craft, craftable = data.craftable, header = data.header, anim = data.anim, amount = k },
			params = { event = "qb-coolbeans:Crafting:MakeItem", args = { item = data.item, craft = data.craft, craftable = data.craftable, header = data.header, anim = data.anim, amount = k } }
		}
	end
	if Config.Menu == "ox" then	exports.ox_lib:registerContext({id = 'Crafting', title = data.header, position = 'top-right', options = Menu })	exports.ox_lib:showContext("Crafting")
	elseif Config.Menu == "qb" then	exports['qb-menu']:openMenu(Menu) end
...
--[[STASH SHOPS]]--
RegisterNetEvent('qb-coolbeans:Stash', function(data)
	--if data.job and not jobCheck() then return end
	if Config.Inv == "ox" then exports.ox_inventory:openInventory('stash', "coolbeans_"..data.stash) else
	TriggerEvent("inventory:client:SetCurrentStash", "coolbeans_"..data.stash)
	TriggerServerEvent("inventory:server:OpenInventory", "stash", "coolbeans_"..data.stash) end
	lookEnt(data.coords)
end)

RegisterNetEvent('qb-coolbeans:Shop', function(data)
	--if not jobCheck() then return end
	...
	TriggerServerEvent(event, "shop", "coolbeans", data.shop)
	lookEnt(data.coords)
end)
...
RegisterNetEvent('qb-coolbeans:client:Consume', function(itemName, type)
	local emoteTable = {
		["sprunk"] = "sprunk", ["sprunklight"] = "sprunk", ["ecola"] = "ecola",	["ecolalight"] = "ecola",
		["ecocoffee"] = "bmcoffee1", ["flusher"] = "bmcoffee2", ["caffeagra"] = "bmcoffee3",
		["donut"] = "donut2", ["chocolate"] = "egobar",
	}
...
-- Till Stuff --
RegisterNetEvent("qb-bean:bill")
AddEventHandler("qb-bean:bill", function()
    ...
    if bill ~= nil then
        ...
        TriggerServerEvent("qb-bean:bill:player", bill[1].input, bill[2].input)
    end
end)
