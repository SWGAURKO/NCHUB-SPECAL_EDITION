...
RegisterNetEvent('nchub-truckrob:CustomNotify')
AddEventHandler('nchub-truckrob:CustomNotify', function(message, type)
...
RegisterNetEvent('nchub-truckrob:PoliceAlert')
AddEventHandler('nchub-truckrob:PoliceAlert', function(coords)
...
Config.RareLootChance = 99					-- Chance to receive rare item in addition to normal reward
Config.RareLootItem = 'security_card_03'	-- Name of rare loot item
...
Config.StartPed = vector4(-1048.614, -524.0357, 36.588905, 28.546127)	-- Location for starting NPC
Config.StartModel = 'a_m_m_eastsa_01'                   	-- Model of starting NPC
