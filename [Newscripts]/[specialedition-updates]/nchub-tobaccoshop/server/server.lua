...
RegisterNetEvent("nchub-tobaccoshop:server:PickUpTobacco", function()
...
QBCore.Functions.CreateCallback("nchub-tobaccoshop:server:makingcigar", function(source, cb, item)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("nchub-tobaccoshop:server:GiveCigar", function(item)
    local Player = QBCore.Functions.GetPlayer(source)
