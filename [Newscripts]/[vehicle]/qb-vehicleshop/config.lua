...
Config.Shops = {
    ['pdm'] = {
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(-326.4717, -1369.59, 31.568296, 187.0), -- where the vehicle will spawn on display
            ...
            [2] = {
                coords = vector4(-332.163, -1380.326, 31.0, 329.0),
                defaultVehicle = 'r8h',
                chosenVehicle = 'r8h',
            },
            [3] = {
                coords = vector4(-319.5068, -1381.952, 31.0, 69.0),
                defaultVehicle = 'lc500',
                chosenVehicle = 'lc500',
            },
            [4] = {
                coords = vector4(-333.2457, -1357.761, 31.0, 209.0),
                defaultVehicle = 'gt86',
                chosenVehicle = 'gt86',
            },
            [5] = {
                coords = vector4(-319.5892, -1360.465, 31.0, 145.0),
                defaultVehicle = 'm4',
                chosenVehicle = 'm4',
            }
        },
