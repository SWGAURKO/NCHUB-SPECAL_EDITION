...
local interactions = {}
-- opens the ui
RegisterNetEvent('nc-elevator:showmenu', function(playerId)
    SendNUIMessage({action = 'showlift'})
    SetNuiFocus(true, true)
end)
-- hides the ui
RegisterNetEvent('nc-elevator:hidemenu', function(playerId)
        ...
        options = {
            {
                ...
                action = function(entity, coords, args)
                    TriggerEvent('nc-elevator:showmenu')
                end,
            },
        }
    }
...
RegisterNUICallback('selectfloor', function(data, cb)
    ...
    if nearestElevator then
        ...
        if selectedFloor then
            ...
            TriggerEvent("nc-elevator:hidemenu")
        else
