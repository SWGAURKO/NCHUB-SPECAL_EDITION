...
function handleUserChoice(choice) {
    $('#modal').fadeOut();
    $.post('https://nc-selldrugs/modalChoice', JSON.stringify(choice));
}
...
function showDeleteConfirmationModal() {
    ...
    $('#modal-button-accept').off('click').on('click', function() {
        if (currentDisplayedConversationId !== undefined) {
            $.post('https://nc-selldrugs/playerDeletedConversation', JSON.stringify(currentDisplayedConversationId));
