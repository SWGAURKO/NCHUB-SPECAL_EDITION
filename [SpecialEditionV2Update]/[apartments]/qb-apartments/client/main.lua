...
local function LeaveApartment(house)
    -- exports['skeepy-backitems']:toggleProps()
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "houses_door_open", 0.1)
    openHouseAnim()
...
RegisterNetEvent('apartments:client:EnterApartment', function()
    exports["wsemotes"]:EmoteCommandStart("point", 1)
    QBCore.Functions.Progressbar("enter_apart", "Entering Apartment..", 300, false, true, {
...
RegisterNetEvent('apartments:client:LeaveApartment', function()
    exports["wsemotes"]:EmoteCommandStart("point", 1)
    QBCore.Functions.Progressbar("leave_apart", "Leaving Apartment..", 300, false, true, {
        disableMovement = true,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
--[[ exports.interact:AddInteraction({
    coords = vector3(-662.36, -1103.19, 15.06),
...
exports.interact:AddInteraction({
    coords = vector3(-659.50, -1100.85, 21.83),
    distance = 3.0, -- optional
    interactDst = 1.5, -- optional
    id = 'apartmentEntrance101', -- needed for removing interactions
    name = 'apartmentEntrance101', -- optional
    options = {
        {
            label = 'Enter Apartment',
            event = "apartments:client:EnterApartment",
...
exports.interact:AddInteraction({
    coords = vector3(-655.57, -1100.13, 21.83),
    distance = 3.0, -- optional
    interactDst = 1.5, -- optional
    id = 'apartmentEntrance102', -- needed for removing interactions
    name = 'apartmentEntrance102', -- optional
    options = {
        {
            label = 'Enter Apartment',
            event = "apartments:client:EnterApartment",
...
exports.interact:AddInteraction({
    coords = vector3(-654.91, -1090.88, 21.83),
    distance = 3.0, -- optional
    interactDst = 1.5, -- optional
    id = 'apartmentEntrance103', -- needed for removing interactions
    name = 'apartmentEntrance103', -- optional
    options = {
        {
            label = 'Enter Apartment',
            event = "apartments:client:EnterApartment",
...
exports.interact:AddInteraction({
    coords = vector3(-650.93, -1090.24, 21.83),
    distance = 2.5, -- optional
    interactDst = 0.5, -- optional
    id = 'apartmentEntrance104', -- needed for removing interactions
    name = 'apartmentEntrance104', -- optional
    options = {
        {
            label = 'Enter Apartment',
            event = "apartments:client:EnterApartment",
...
exports.interact:AddInteraction({
    coords = vector3(-646.26, -1080.28, 21.83),
    distance = 3.0, -- optional
    interactDst = 1.5, -- optional
    id = 'apartmentEntrance105', -- needed for removing interactions
    name = 'apartmentEntrance105', -- optional
    options = {
        {
            label = 'Enter Apartment',
            event = "apartments:client:EnterApartment",
...
--leave appartment--
exports.interact:AddInteraction({
    coords = vector3(-650.33, -1090.42, 21.83),
    distance = 2.0, -- optional
    interactDst = 0.5, -- optional
    id = 'apartmentEntrance1', -- needed for removing interactions
    name = 'apartmentEntrance1', -- optional
    options = {
         {
...
--Stash--
exports.interact:AddInteraction({
    coords = vector3(-652.07, -1095.97, 21.65), 
    distance = 2.5, -- optional
    interactDst = 1.3, -- optional
    id = 'apartmentEntrance2', -- needed for removing interactions
    name = 'apartmentEntrance2', -- optional
    options = {
         {
            label = 'Open Stash',
            event = "",
...
--Wardrobe--
exports.interact:AddInteraction({
    coords = vector3(-649.64, -1092.92, 21.83),
    distance = 2.0, -- optional
    interactDst = 1.0, -- optional
    id = 'apartmentEntrance3', -- needed for removing interactionssa
    name = 'apartmentEntrance3', -- optional
    options = {
         {
            label = 'Wardrobe',
