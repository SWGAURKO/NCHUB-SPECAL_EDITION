RegisterNetEvent('nc-chopshop:wheelanimation')
AddEventHandler('nc-chopshop:wheelanimation', function()
...
RegisterNetEvent('nc-chopshop:dooranimation')
AddEventHandler('nc-chopshop:dooranimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('nc-chopshop:trunkanimation')
AddEventHandler('nc-chopshop:trunkanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('nc-chopshop:hoodanimation')
AddEventHandler('nc-chopshop:hoodanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('nc-chopshop:wheelchopanim')
AddEventHandler('nc-chopshop:wheelchopanim', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('nc-chopshop:doorchopanim')
AddEventHandler('nc-chopshop:doorchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('nc-chopshop:hoodchopanim')
AddEventHandler('nc-chopshop:hoodchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('nc-chopshop:trunkchopanim')
AddEventHandler('nc-chopshop:trunkchopanim', function()
	local ped = PlayerPedId()
