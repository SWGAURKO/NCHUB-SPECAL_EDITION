...
Citizen.CreateThread(function()
    ...
    replace_ytd_contents("platform:/textures/fxdecal", "nc_fxdecal_1", nve_fxdecal_files_1)
    replace_ytd_contents("platform:/textures/fxdecal", "nc_fxdecal_2", nve_fxdecal_files_2)
    replace_ytd_contents("platform:/textures/fxdecal", "nc_fxdecal_3", nve_fxdecal_files_3)
    replace_ytd_contents("platform:/textures/fxweather", "nc_fxweather", nve_fxweather_files)
    replace_ytd_contents("platform:/textures/graphics", "nc_graphics", nve_graphics_files)
	replace_ytd_contents("platform:/textures/mapdetail", "nc_mapdetail", nve_mapdetail_files)
	replace_ytd_contents("platform:/textures/peddamagedecals", "nc_peddamagedecals", nve_peddamagedecals_files)
    replace_ytd_contents("skydome", "nc_skydome", nve_skydome_files)
	replace_ytd_contents("vehshare", "nc_vehshare", nve_vehshare_files)
	replace_ytd_contents("platform:/textures/water", "nc_water", nve_water_files)
end)