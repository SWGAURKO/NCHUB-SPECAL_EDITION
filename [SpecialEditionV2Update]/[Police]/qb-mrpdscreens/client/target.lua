...
if Config.QBtarget then
    ...
    exports[Config.Target]:AddBoxZone("mrpdclassroom", vector3(625.52508, 3.8620779, 86.786827), 0.5, 3.0, {
        name="mrpdclassroom",
        --debugPoly=true,
        -- minZ=87.0,
        -- maxZ=89.0
...
elseif Config.BTTarget then
    exports[Config.Target]:AddBoxZone("mrpdscreen", vector3(625.52539, 3.7860002, 86.83007), 2.6, 0.4,{
        name="mrpdscreen",
        heading=0,
        minZ=85.83007,
        maxZ=87.83007,
