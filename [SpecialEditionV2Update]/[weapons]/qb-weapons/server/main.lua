...
QBCore.Functions.CreateCallback("weapons:server:RepairWeapon", function(source, cb, RepairPoint, data)
    ...
    local Timeout = math.random(3 * minute, 5 * minute)
    ...
    if Player.PlayerData.items[data.slot] then
        if Player.PlayerData.items[data.slot].info.quality then
            if Player.PlayerData.items[data.slot].info.quality ~= 100 then
                local repairCost = math.floor(Config.WeaponRepairCosts[WeaponClass] * (100 - Player.PlayerData.items[data.slot].info.quality) / 100)
...
QBCore.Functions.CreateCallback('prison:server:checkThrowable', function(source, cb, weapon)
    ...
    elseif QBCore.Shared.Weapons[weapon]["name"] == "weapon_smok2grenade" then
        Player.Functions.RemoveItem("weapon_smok2grenade", 1)
...
RegisterNetEvent("weapons:server:UpdateWeaponAmmo", function(CurrentWeaponData, amount)
    ...
    if CurrentWeaponData then
        if CurrentWeaponData.name == "weapon_cash" then
            TriggerClientEvent("rhodo:setAmount", src, CurrentWeaponData.info.amountCash)
...
RegisterNetEvent("weapons:server:SetQuality")
AddEventHandler("weapons:server:SetQuality", function(target, item, decrease)
    local src = target
    local Player = QBCore.Functions.GetPlayer(src)
    local weapon = Player.Functions.GetItemByName(item)
    print(weapon["info"])
    print(weapon["info"]["quality"])
    Player.Functions.SetInventory(Player.PlayerData.items, true)
end)
            ...
            if WeaponSlot.info.quality ~= nil then
                for i = 1, RepeatAmount, 1 do
                    if WeaponSlot.info.quality - DecreaseAmount > 0 then
                        ...
                        TriggerClientEvent('QBCore:Notify', src, "Your weapon is broken, you must repair it before you can use it again.", "error")
                        break
                    end
                end
            else
...
QBCore.Functions.CreateUseableItem('pistol_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_PISTOL', 50, item)
end)

QBCore.Functions.CreateUseableItem('paintball-ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_PAINTBALL', 50, item)
end)

QBCore.Functions.CreateUseableItem('taserammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_TASER', 50, item)
end)

QBCore.Functions.CreateUseableItem('mana', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_STAFF', 50, item)
end)

QBCore.Functions.CreateUseableItem('firework_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_RPG', 50, item)
end)
...
QBCore.Functions.CreateUseableItem('rifle_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_RIFLE', 50, item)
end)

QBCore.Functions.CreateUseableItem('smg_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_SMG', 50, item)
end)

QBCore.Functions.CreateUseableItem('shotgun_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_SHOTGUN', 50, item)
end)

QBCore.Functions.CreateUseableItem('mg_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_MG', 50, item)
end)

QBCore.Functions.CreateUseableItem('snp_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_SNIPER', 50, item)
end)

QBCore.Functions.CreateUseableItem('emp_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_EMP', 50, item)
end)
...
QBCore.Functions.CreateUseableItem('weapon_uzi_foldstock', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'foldstock')
end)

QBCore.Functions.CreateUseableItem('weapon_uzi_woodstock', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'woodstock')
end)
...
QBCore.Functions.CreateUseableItem('uzi_extendedclip', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'extendedclip')
end)

QBCore.Functions.CreateUseableItem('mac10_extendedclip', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'extendedclip')
end)
