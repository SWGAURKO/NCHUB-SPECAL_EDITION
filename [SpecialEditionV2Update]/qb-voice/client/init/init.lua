...
AddEventHandler('onClientResourceStart', function(resource)
	...
	-- Some people modify qb-voice and mess up the resource Kvp, which means that if someone
	-- joins another server that has qb-voice, it will error out, this will catch and fix the kvp.
