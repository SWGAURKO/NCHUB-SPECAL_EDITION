...
RegisterNetEvent("nchub-hud:Client:HandleCallback", function(key, data)
...
RegisterNetEvent("nchub-hud:Client:OpenHudSettings", function()
    SetNuiFocus(true, true)
    Koci.Client:SendReactMessage("setRouter", "settings")
end)
RegisterNetEvent("nchub-hud:Client:SetManualGear", function(newGear)
...
elseif GetResourceState("saltychat") == "started" then
    ...
    TriggerServerEvent("nchub-hud:Server:ErrorHandle", "Setup your custom voice resource at: client/utils.lua")
