...
-- Discord preview receipts
	...
	DiscordDefault = "https://discord.com/api/webhooks/1129769773601914931/0fiKDDzq7kU3hiakvcQ0TurJeMao0gSd17tABbXShCus3GYBAlei3S9zeLqK9gw59AfC", -- Set this to the default channel API link if one isn't set for a location
...
--DuctTape Controllers
	...
	JobRoles = { "redline", "mechanic" }, -- These are the job roles who can use items if RequiresJob is enabled.
