...
Config.PoliceLocations = {
    ...
    { coords = vector3(451.05, -973.19, 25.7), heading = 180.0, }, -- MRPD UNDERGROUND PARKING
    { coords = vector3(342.51, -570.98, 28.8), heading = 70.0, }, -- PILL BOX GARAGE
}
...
-- 		bench[#bench+1] = makeProp({ prop = `gr_prop_gr_bench_03a`, coords = vector4(v.coords.x, v.coords.y, v.coords.z-1.37, v.heading)}, 1, 0)
