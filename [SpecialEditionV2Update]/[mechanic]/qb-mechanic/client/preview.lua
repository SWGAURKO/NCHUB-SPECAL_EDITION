...
exports["qb-target"]:AddCircleZone("btray3", vector3(132.47126, -3016.833, 7.3634948), 0.6,
    {
        name = "btray3",
        debugPoly = false,
        useZ = true
    },
    {
        options = {
            {
                event = "qb-mechanic:interact:stash",
                icon = "fas fa-circle",
...
exports["qb-target"]:AddCircleZone("clothingred", vector3(473.54891, -570.7662, 28.697641), 0.6,
    {
        name = "clothingred",
        debugPoly = false,
        useZ = true
    },
    {
        options = {
            {
                event = "qb-redline:interact:stash",
                icon = "fas fa-circle",
                label = "Open Personal Locker",
                job = "redline",
            },
