...
CreateThread(function()
	...
	--Make Store Locations
		...
		CreateThread(function()
			exports['qb-target']:AddBoxZone("shopredli", vector3(-531.9882, -2212.474, 6.319868), 1, 1.2, {
				name = "shopredli",
				heading = 275.0,
				debugPoly = false,
			}, {
		...
		CreateThread(function()
			exports['qb-target']:AddBoxZone("shopredlinecos", vector3(473.0505, -557.0892, 28.62351), 1, 1.2, {
				name = "shopredlinecos",
				heading = 275.0,
				debugPoly = false,
			}, {
				options = {
					{  
					event = "jim-mechanic:client:Store:Menu3",
					icon = "far fa-clipboard",
					label = "Open Shop",
					job = "redline",
					},
		...
		CreateThread(function()
			exports['qb-target']:AddBoxZone("shopredli", vector3(462.98223, -553.2806, 28.51378), 1, 1.2, {
				name = "shopredli",
				heading = 275.0,
				debugPoly = false,
			}, {
...
RegisterNetEvent('jim-mechanic:Crafting:ItemProgress', function(data)
	...
	{}, {}, function()
		TriggerServerEvent('qb-logs:server:createLog', 'itemprogress', 'ItemProgress', "", src)
...
RegisterNetEvent('jim-mechanic:client:NosRefill', function(data)
	...
	if cash >= Config.NosRefillCharge then
		...
		{}, {}, function()
			TriggerServerEvent('qb-logs:server:createLog', 'nosrefill', 'NosRefill', "", src)
...
RegisterNetEvent('jim-mechanic:client:Store:Menu2', function(data)
    exports['qb-menu']:openMenu({
        { header = Loc[Config.Lan]["stores"].tools, txt = "", params = { event = "jim-mechanic:client:Store", args = { id = 1, job = data.job } } },
        { header = Loc[Config.Lan]["stores"].perform, txt = "", params = { event = "jim-mechanic:client:Store", args = { id = 2, job = data.job } } },
    })
...
RegisterNetEvent('jim-mechanic:client:Store:Menu3', function(data)
    exports['qb-menu']:openMenu({
		{ header = Loc[Config.Lan]["stores"].cosmetic, txt = "", params = { event = "jim-mechanic:client:Store", args = { id = 3, job = data.job } } },
    })
end)
...
Config.Locations = {
	...
	{	job = "mechanic",
		zones = {
			vector2(155.88185, -3015.804),
			vector2(156.73323, -3056.082),
			vector2(116.24192, -3056.952),
			vector2(117.26349, -3015.537),
		},
		autoClock = { enter = false, exit = false, },
		stash = { { coords = vector4(132.47126, -3016.833, 7.3634948, 1.1337648), w = 3.6, d = 0.6 }, },
		store = { { coords = vector4(127.3973, -3041.254, 6.9780845, 180.57949), w = 1.6, d = 0.6 }, },
		-- crafting = { { coords = vector4(-38.25, -1038.99, 28.6, 340.0), w = 4.0, d = 0.6 }, },
		clockin = { { coords = vector4(148.932, -3019.414, 7.2398571, 258.30102), prop = true, }, },
		manualRepair = { { coords = vector4(128.02558, -3026.354, 7.040533, 358.69512), prop = true, } },
		-- garage = { spawn = vector4(-1623.44, -796.3818, 10.189777, 332.81063),
		-- 			out = vector4(-42.38, -1035.11, 28.52, 68.01),
		-- 			list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
		-- 			prop = true, },
		payments = { coords = vector4(143.41513, -3052.648, 7.4174389, 347.5469),
			...
			prop = true, },
		blip = vector3(160.91758, -3034.458, 6.8747482),
		bliplabel = "StrokeMaster Tuner Workshop",    -- Bennys Workshop next to PDM
		blipcolor = 5,
		discordlink = "",
	...
	{	job = "redline",
		zones = {
			vector2(474.4, -576.47),
			vector2(448.2, -573.81),
			vector2(453.73, -548.38),
			vector2(476.63, -554.86),
		},
		autoClock = { enter = false, exit = false, },
        ...
        payments = { coords = vector4(-200.68, -1314.53, 31.08, 0.0),
			img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/be/BennysOriginalMotorWorks-GTAO-Logo.png width=150px></p>",
			prop = true },
		-- blip = vector3(-518.4421, -2211.445, 6.4434542),
	...
	-- 	},
	-- 	autoClock = { enter = false, exit = false, },
	-- 	stash = { { coords = vector4(478.84, -1326.94, 29.21, 27.0), w = 1.6, d = 0.6, }, },
	-- 	store = { { coords = vector4(474.83, -1308.06, 29.21, 295.0), w = 1.6, d = 0.5, }, },
	-- 	crafting = { { coords = vector4(472.54, -1313.22, 29.21, 30.0), w = 3.2, d = 1.0, }, },
	-- 	clockin = { { coords = vector4(471.51, -1310.97, 29.22, 23.0), w = 0.45, d = 0.4, }, },
	-- 	manualRepair = { { coords = vector4(483.51, -1302.66, 29.3, 180.38), prop = true, } },
	-- 	garage = { spawn = vector4(487.67, -1308.78, 28.6, 233.44),
	-- 				out = vector4(483.06, -1311.35, 29.21, 298.78),
	-- 				list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
	-- 				prop = true },
	-- 	payments = { coords = vector4(485.88, -1319.49, 29.11, 284.0),
	...
	-- 	},
	-- 	autoClock = { enter = false, exit = false, },
	-- 	stash = { { coords = vector4(736.25, -1063.52, 22.17, 87.0), w = 3.2, d = 0.6, heading = 87.0 }, },
	-- 	store = { { coords = vector4(738.35, -1073.36, 22.17, 359.0), w = 3.8, d = 0.6, heading = 359.0 }, },
	-- 	crafting = { { coords = vector4(724.49, -1075.09, 22.17, 91.0), w = 0.8, d = 1.0, heading = 91.0 }, },
	-- 	clockin = { { coords = vector4(738.26, -1087.66, 21.97, 276.0), prop = true, }, },
	-- 	manualRepair = { { coords = vector4(732.89, -1093.79, 22.17, 351.08), prop = true, } },
	-- 	garage = { spawn = vector4(716.22, -1069.58, 21.6, 1.08),
	-- 				out = vector4(719.63, -1068.84, 22.24, 89.2),
	-- 				list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
	-- 				prop = true },
	-- 	payments = { coords = vector4(738.34, -1090.52, 21.97, 220.0),
	-- 		img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png width=150px></p>",
	-- 		prop = true, },
	...
	-- 	},
	-- 	autoClock = { enter = false, exit = false, },
	-- 	stash = { { coords = vector4(948.48, -972.38, 39.5, 5.0), w = 1.5, d = 1.0, }, },
	-- 	store = { { coords = vector4(951.14, -979.1, 39.5, 4.0), w = 4.2, d = 1.0, }, },
	-- 	crafting = { { coords = vector4(921.14, -986.24, 39.5, 4.0), w = 1.0, d = 4.0, }, },
	-- 	clockin = { { coords = vector4(952.1, -968.39, 39.31, 273.2), }, prop = true, },
	-- 	manualRepair = { { coords = vector4(911.67, -978.21, 39.5, 274.64), prop = true, } },
	-- 	garage = { spawn = vector4(937.02, -990.27, 38.34, 93.92),
	-- 				out = vector4(936.81, -987.17, 38.34, 184.37),
	-- 				list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
	-- 				prop = true },
	-- 	payments = {
	-- 		coords = vector4(949.46, -968.68, 39.31, 92.0),
	-- 		img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png width=150px></p>",
	-- 		prop = true },
	...
	-- 	},
	-- 	autoClock = { enter = false, exit = false, },
	-- 	stash = { { coords = vector4(836.97, -814.73, 26.33, 90.0), w = 0.6, d = 3.6, }, },
	-- 	store = { { coords = vector4(837.02, -808.22, 26.33, 90.0), w = 1.0, d = 1.4, }, },
	-- 	crafting = { { coords = vector4(837.03, -811.74, 26.33, 90.0), w = 1.4, d = 2.2, }, },
	-- 	clockin = { { coords = vector4(834.63, -829.76, 26.13, 197.67), prop = true, }, },
	-- 	manualRepair = { { coords = vector4(835.0, -801.06, 26.27, 0.25), prop = true, } },
	-- 	garage = { spawn = vector4(826.59, -793.63, 26.21, 84.34),
	-- 				out = vector4(824.3, -801.2, 26.37, 0.65),
	-- 				list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
	-- 				prop = true },
	-- 	payments = { coords = vector4(833.96, -826.79, 26.13, 0.35),
	...
	-- 	},
	-- 	autoClock = { enter = false, exit = false, },
	-- 	stash = { { coords = vector4(-1414.94, -452.35, 35.91, 302.0), w = 4.0, d = 1.0, }, },
	-- 	store = { { coords = vector4(-1408.04, -448.04, 35.91, 302.0), w = 5.5, d = 1.0, }, },
	-- 	crafting = { { coords = vector4(-1407.68, -442.32, 35.91, 302.0), w = 0.6, d = 1.0, }, },
	-- 	clockin = { { coords = vector4(-1427.19, -457.51, 35.71, 300.0), prop = true, }, },
	-- 	manualRepair = { { coords = vector4(-1421.91, -455.41, 35.91, 33.32), prop = true, } },
	-- 	garage = { spawn = vector4(-1379.84, -451.82, 34.44, 124.0),
	-- 				out = vector4(-1401.57, -451.19, 34.48, 212.71),
	-- 				list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" } },
	-- 	payments = { coords = vector4(-1429.02, -453.6, 35.97, 350.0),
	-- 		img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/0/0c/HayesAutoBodyShop-GTAV-Logo.png width=150px></p>",
	-- 		prop = true, },
